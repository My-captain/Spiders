...
// @version      0.1
// @author       Mr.Robot
// @include       http://tieba.baidu.com/f/search/res?*
...
function() {
    ...
    $(window).on("load", function() {
        ...
        var keyword_from_search = $("#wd1").attr("value");
        console.log(keyword_from_search);
        $(".s_post_list").find(".s_post").each(function() {
            var title = $(this).find(".p_title").contents().text();
            var url = "tieba.baidu.com" + $(this).find(".p_title").find("a").attr("href");
            var brief_of_content = $(this).find(".p_content").contents().text();
            var tieba = $(this).find(".p_forum").contents().text();
            var account = $(this).find(".p_violet").contents().text();
            var time = $(this).find(".p_date").contents().text();
            account = account - tieba;
            var hash = {
            ...
            console.log(keyword_from_search+"@"+title+"@"+brief_of_content+"@"+url+"@"+account+"@"+tieba+"@"+time);
        ...
        if ($(".next").contents().text() != "") {
            ...
            if (confirm_save) {
                var file_name = "tieba-" + keyword_from_search + ".json";
